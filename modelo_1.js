...
fs.readdir(IMAGE_FOLDER, async (err, files) => {
    ...
    fs.writeFileSync(
        path.join(__dirname, "modelo_1.json"),
        JSON.stringify(resultado, null, 4),
        "utf-8"
    );

    console.log("\n✅ Resultado salvo em modelo_1.json");
});
